...
async function printMarkdown(content: string): Promise<void> {
    if (process.stdout.isTTY) {
        ...
        // markedはシングルトンだが、毎回useしても問題ないか？
        // marked v17 might behave differently.
        // But usually it appends extensions.
        // We can check if it's already using terminal?
        // Or just re-apply, marked usually handles it.
        // Or better: construct a new instance if possible, or just use global since we run once.
