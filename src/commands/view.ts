...
// Singleton for marked instance to prevent duplicate extension registration
...
async function printMarkdown(content: string): Promise<void> {
    if (process.stdout.isTTY) {
        ...
        // Note: Dynamic import makes this function async anyway, so we can await if needed,
        // but marked.parse behavior depends on options.
